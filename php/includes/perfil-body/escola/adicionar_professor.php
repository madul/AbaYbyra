  ...
  <div class="row mt-4">
    ...
    <div class="col-sm-2 mt-5 borda2 ">
      <nav class="nav flex-column " >
        <a class="nav-link mb-2 borda2 active bg-success" href="#">Dados Pessoais</a>
        <a class="nav-link mb-2 borda2 bg-success" href="#">História e atividades</a>
        <a class="nav-link mb-2 borda2 bg-success" href="#">Adicionar Professores</a>
        <a class="nav-link mb-2 borda2 bg-success" href="#">Disabled</a>
      </nav>
    </div>
