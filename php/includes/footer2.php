<footer id="footer2" class="container-fluid p-0 m-0 d-flex flex-column align-items-center justify-content-center">
    <div id="footer-content" class="w-50 pt-3 container-fluid">
      ...
      <div class="text-container w-100 text-center pt-1">
          <p class="mb-0">&copy; ABÁ YBYRÁ </p>
          <!-- <p class="mt-0"><small> Design por: www.freepik.com.</small></p> -->
      </div>   
    </div>     
</footer>