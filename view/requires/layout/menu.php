          ...
          <div class="mr-5 nav-container navbar-nav justify-content-between w-50">
            ...
            <?php if (isset($_SESSION['autenticado_aluno']) || isset($_SESSION['autenticado_escola'])): ?>
              ...
              <div class="dropdown-menu">
                <a class="text-center dropdown-item text-success" href="../perfil/profile.php">Meus Dados</a>


               <?php if(isset($_SESSION['autenticado_escola'])): ?>
                 <a class="text-center dropdown-item text-success " href="../perfil/escola_add.php">Adicionar Professor</a>
                  <a class="text-center dropdown-item text-success " href="../perfil/escola_professor.php">Lista Professores</a>

               <?php endif; ?>
                   <a class="text-center dropdown-item text-success " href="../perfil/aluno_area.php">Área do aluno</a>
                <div class="dropdown-divider text-success"></div>
                <a href="../perfil/logout.php" class="dropdown-item  text-center text-danger header-icon nav-item nav-link"><strong>logout</strong></a>
              </div>
            </div>
            ...
            <?php endif; ?>
              ...
              <a href="../pages/contato.php" class="header-icon nav-item nav-link">CONTATO</a>
