<main>
     ...
     <div id="index-body"  class="container-fluid row">
       ...
       <div id="login-container" class= " min col-sm-12 col-md-4 border my-2 bg-white">
...
<?php
      ...
      */ ?>
      ...
      ?>
           ...
           <form  id="form-login" class="p-2 d-flex flex-column justify-content-start" action="./php/actions/login.php" method="POST">
             ...
             <div class="password-container form-group">
               ...
               <input type="password" id='password' name='password' class="form-control" placeholder="Digite sua senha" required>
                  ...
                  <a role="button" class="btn btn-warning" href='./view/cadastros/cadastro-aluno.php'>Cadastrar</a>
